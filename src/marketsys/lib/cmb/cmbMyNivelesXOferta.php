<?php
 SESSION_START();
	...
	$consulta = $db->consulta("SELECT oc.id_secuencia id, ".
									 "concat(nv.descripcion,' ','".chr(34)."',oc.paralelo,'".chr(34)."') descripcion ".
							   ...
							   "WHERE oc.estado = 'A' ".
								 ...
								 "AND oc.id_secuencia IN (SELECT o.id_secuencia ".
														 "FROM tac_asignaturas_niveles_oferta_centros o ".
													    "WHERE o.estado = 'A' ".
													      "AND oc.id_centro = o.id_centro ".
														  "AND oc.id_periodo = o.id_periodo ".
														  "AND oc.secuencia = o.secuencia ".
														  "AND o.id_profesor = '".$_SESSION["idUsuario"]."') ".
