        ...
        *************************************************************************/
        options: {
            ...
            messages: {
                ...
                noDataAvailable: 'Información no diponible!',
                ...
                error: 'Error',
                close: 'Cerrar',
                cannotLoadOptionsFor: 'No pueden cargarse opciones para el campo {0}'
            }
        },
        ...
        *************************************************************************/
        _createRowFromRecord: function (record) {
            var $tr = $('<tr></tr>')
				...
				.click(function(){
						consultaProceso(record[3],record[5],record[0],record[2],record[1],record[15]);
					})
                .data('record', record);
    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        *************************************************************************/
        _showEditForm: function ($tableRow) {
            ...
            //Create edit form
            var $editForm = $('<form id="jtable-edit-form" class="jtable-dialog-form jtable-edit-form" style="margin: 0px;"></form>');
    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        *************************************************************************/
        options: {
            ...
            //Localization
            messages: {
                deleteConfirmation: 'Este Elemento será eliminado. Está seguro?',
                deleteText: 'Eliminar',
                deleting: 'Eliminando',
                canNotDeletedRecords: 'No se pudo eliminar {0} de {1} registro!',
        ...
        *************************************************************************/
        _createDeleteDialogDiv: function () {
            ...
            self._$deleteRecordDiv = $('<div><p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><span class="jtable-delete-confirm-message" style="font-size: 12px;"></span></p></div>').appendTo(self._$mainContainer);
...
function consultaProceso(idFlujo, idDetalleFlujo, idTramite, idSeguimiento, tituloForm, rutaFom){
	window.top.document.getElementById('load').style.display = 'block';
	rutaFom = 'forms/atencionCiudadana/viewDetalleTramite.php?idFlujo='+idFlujo+'&idDetalleFlujo='+idDetalleFlujo+'&idTramite='+idTramite+'&idSeguimiento='+idSeguimiento;
	window.top.frames["PPrincipal"].createNewTab('Tab_dhtml',tituloForm,'',rutaFom,true,idFlujo, idDetalleFlujo, idTramite, idSeguimiento);	
}