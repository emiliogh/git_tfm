	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tbEstadosCiviles.php?action=list',
					createAction: 'crud_tbEstadosCiviles.php?action=create',
					updateAction: 'crud_tbEstadosCiviles.php?action=update',
					deleteAction: 'crud_tbEstadosCiviles.php?action=delete',
				},
				fields: {
					id_genero: {
						key: true,
