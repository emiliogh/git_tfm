	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Géneros',
				actions: {
					listAction: 'crud_tbGeneros.php?action=list',
					createAction: 'crud_tbGeneros.php?action=create',
					updateAction: 'crud_tbGeneros.php?action=update',
					deleteAction: 'crud_tbGeneros.php?action=delete',
				},
				fields: {
					id_genero: {
						key: true,
