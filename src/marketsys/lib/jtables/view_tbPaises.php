	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Países',
				actions: {
					listAction: 'crud_tbPaises.php?action=list',
					createAction: 'crud_tbPaises.php?action=create',
					updateAction: 'crud_tbPaises.php?action=update',
					deleteAction: 'crud_tbPaises.php?action=delete',
				},
				fields: {
					id: {
						key: true,
