	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tbPerfiles.php?action=list',
					createAction: 'crud_tbPerfiles.php?action=create',
					updateAction: 'crud_tbPerfiles.php?action=update',
					deleteAction: 'crud_tbPerfiles.php?action=delete',
				},
				fields: {
					id_perfil: {
						key: true,
