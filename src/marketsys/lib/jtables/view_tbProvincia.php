	...
	<script type="text/javascript">		
		$(document).ready(function () {
			...
			$('#tableContainer').jtable({
				title: 'Provincias',
				actions: {
					listAction: 'crud_tbProvincia.php?action=list',
					createAction: 'crud_tbProvincia.php?action=create',
					updateAction: 'crud_tbProvincia.php?action=update',
					deleteAction: 'crud_tbProvincia.php?action=delete',
				},
				fields: {
					id_provincia: {
						key: true,
