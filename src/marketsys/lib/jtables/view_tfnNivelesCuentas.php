	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Niveles de Cuentas',
				actions: {
					listAction: 'crud_tfnNivelesCuentas.php?action=list',
					createAction: 'crud_tfnNivelesCuentas.php?action=create',
					updateAction: 'crud_tfnNivelesCuentas.php?action=update',
					deleteAction: 'crud_tfnNivelesCuentas.php?action=delete',
				},
				fields: {
					id_nivel: {
						key: true,
