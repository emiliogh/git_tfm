	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Períodos',
				actions: {
					listAction: 'crud_tfnPeriodos.php?action=list',
					createAction: 'crud_tfnPeriodos.php?action=create',
					updateAction: 'crud_tfnPeriodos.php?action=update',
					deleteAction: 'crud_tfnPeriodos.php?action=delete',
				},
				fields: {
					id_periodo: {
						key: true,
