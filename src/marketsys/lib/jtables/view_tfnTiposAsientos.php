	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Tipos de Asientos Contables',
				actions: {
					listAction: 'crud_tfnTiposAsientos.php?action=list',
					createAction: 'crud_tfnTiposAsientos.php?action=create',
					updateAction: 'crud_tfnTiposAsientos.php?action=update',
					deleteAction: 'crud_tfnTiposAsientos.php?action=delete',
				},
				fields: {
					id_tipo_asiento: {
						key: true,
