	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tfnTiposCuentas.php?action=list',
					createAction: 'crud_tfnTiposCuentas.php?action=create',
					updateAction: 'crud_tfnTiposCuentas.php?action=update',
					deleteAction: 'crud_tfnTiposCuentas.php?action=delete',
				},
				fields: {
					id_tipo_cuenta: {
						key: true,
