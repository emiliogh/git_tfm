	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Perfiles',
				actions: {
					listAction: 'crud_tgnCargos.php?action=list',
					createAction: 'crud_tgnCargos.php?action=create',
					updateAction: 'crud_tgnCargos.php?action=update',
					deleteAction: 'crud_tgnCargos.php?action=delete',
				},
				fields: {
					id_cargo: {
						key: true,
