	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				title: 'Unidades',
				actions: {
					listAction: 'crud_tgnDepartamentos.php?action=list',
					createAction: 'crud_tgnDepartamentos.php?action=create',
					updateAction: 'crud_tgnDepartamentos.php?action=update',
					deleteAction: 'crud_tgnDepartamentos.php?action=delete',
				},
				fields: {
					id_departamento: {
						key: true,
