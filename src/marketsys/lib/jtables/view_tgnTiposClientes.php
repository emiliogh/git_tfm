	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tgnTiposClientes.php?action=list',
					createAction: 'crud_tgnTiposClientes.php?action=create',
					updateAction: 'crud_tgnTiposClientes.php?action=update',
					deleteAction: 'crud_tgnTiposClientes.php?action=delete',
				},
				fields: {
					id_tipo_cliente: {
						key: true,
