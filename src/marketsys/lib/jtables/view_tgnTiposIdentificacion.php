	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tgnTiposIdentificacion.php?action=list',
					createAction: 'crud_tgnTiposIdentificacion.php?action=create',
					updateAction: 'crud_tgnTiposIdentificacion.php?action=update',
					deleteAction: 'crud_tgnTiposIdentificacion.php?action=delete',
				},
				fields: {
