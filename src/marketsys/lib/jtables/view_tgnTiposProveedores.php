	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction:   'crud_tgnTiposProveedores.php?action=list',
					createAction: 'crud_tgnTiposProveedores.php?action=create',
					updateAction: 'crud_tgnTiposProveedores.php?action=update',
					deleteAction: 'crud_tgnTiposProveedores.php?action=delete',
				},
				fields: {
					id_tipo_proveedor: {
						key: true,
