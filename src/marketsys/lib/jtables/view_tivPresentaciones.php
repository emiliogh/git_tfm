	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tivPresentaciones.php?action=list',
					createAction: 'crud_tivPresentaciones.php?action=create',
					updateAction: 'crud_tivPresentaciones.php?action=update',
					deleteAction: 'crud_tivPresentaciones.php?action=delete',
				},
				fields: {
					id_presentacion: {
						key: true,
