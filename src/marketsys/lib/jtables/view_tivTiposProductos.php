	...
	<script type="text/javascript">		
		$(document).ready(function () {
			$('#tableContainer').jtable({
				...
				actions: {
					listAction: 'crud_tivTiposProductos.php?action=list',
					createAction: 'crud_tivTiposProductos.php?action=create',
					updateAction: 'crud_tivTiposProductos.php?action=update',
					deleteAction: 'crud_tivTiposProductos.php?action=delete',
				},
				fields: {
					id_tipo_producto: {
						key: true,
