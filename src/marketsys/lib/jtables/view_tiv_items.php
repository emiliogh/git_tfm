...
<html>
  <head>
	...
	<!-- bootstrap theme-->
	<link rel="stylesheet" href="../../lib/css/bootstrap/bootstrap-theme.min.css">
	<!-- font awesome -->
  ...
  <!-- file input -->
  <link rel="stylesheet" href="../../lib/css/fileinput/css/fileinput.min.css">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editCategoryName" name="editCategoryName" >
						      	<option value="">~~SELECT~~</option>
						      	<?php 
						      	$sql = "SELECT id_categoria, descripcion FROM tiv_categorias WHERE estado = 'A'";
										$result = $connect->query($sql);
...
<script src="../../lib/js/product.js"></script>
	...
	<!-- file input -->
	<script src="../../lib/css/fileinput/js/plugins/canvas-to-blob.min.js'); ?>" type="text/javascript"></script>	
	<script src="../../lib/css/fileinput/js/plugins/sortable.min.js" type="text/javascript"></script>	
	<script src="../../lib/css/fileinput/js/plugins/purify.min.js" type="text/javascript"></script>
	<script src="../../lib/css/fileinput/js/fileinput.min.js"></script>	
