	...
	<script type="text/javascript">		
		$(document).ready(function () {
			...
			$('#tableContainer').jtable({
				title: 'Número de documentos por puntos de emisión',
				actions: {
					listAction: 'crud_tscPuntosEmisionSec.php?action=list',
					updateAction: 'crud_tscPuntosEmisionSec.php?action=update',
				},
				fields: {
					id_punto_emision: {
						key: true,
